# imsi_catcher
Single repository to store all of the necessary elements required to create a simple IMSI catcher for non-specialist users. I built this project to take account of the outdated guides that have not kept paces with the changes to GNUradio, gr-gsm, and the Simple_IMSI-catcher.py packages. A working main repo will be maintained here. All credit to the individual projects, joined here for ease of use.
